...
namespace ProjectIndependence.API.Infrastructure.Migrations
{
    ...
    [Migration("20260220080124_AddProductNavigationToInventoryMovement")]
    partial class AddProductNavigationToInventoryMovement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectIndependence.API.Core.Entities.Inventories.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectIndependence.API.Core.Entities.Inventories.InventoryMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectIndependence.API.Core.Entities.Inventories.InventoryMovement", b =>
                {
                    b.HasOne("ProjectIndependence.API.Core.Entities.Inventories.Inventory", null)
                        .WithMany("Movements")
                        .HasForeignKey("InventoryId");

                    b.HasOne("ProjectIndependence.API.Core.Entities.Products.Product", "Product")
                        .WithMany()
